...
#ifndef COMPONENTFACEDETECTION_EXTENSION_HH_
#define COMPONENTFACEDETECTION_EXTENSION_HH_
...
public:
	ComponentFaceDetectionExtension(const std::string &name);
	virtual ~ComponentFaceDetectionExtension();
...
#endif /* COMPONENTFACEDETECTION_EXTENSION_HH_ */
