...
Pnet::Pnet(){
    ...
    string filename = "/home/rosmosys/MTCNN-light/Pnet.txt";
...
Rnet::Rnet(){
    ...
    string filename = "/home/rosmosys/MTCNN-light/Rnet.txt";
    readData(filename, dataNumber, pointTeam);
...
Onet::Onet(){
    ...
    string filename = "/home/rosmosys/MTCNN-light/Onet.txt";
    readData(filename, dataNumber, pointTeam);
