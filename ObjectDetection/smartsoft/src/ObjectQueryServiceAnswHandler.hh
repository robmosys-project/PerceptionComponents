...
protected:
public:
	ObjectQueryServiceAnswHandler(Smart::IQueryServerPattern<CommPerception::CommInfDetection, CommPerception::CommObjectRecognitionObjectProperties, SmartACE::QueryId>* server);
