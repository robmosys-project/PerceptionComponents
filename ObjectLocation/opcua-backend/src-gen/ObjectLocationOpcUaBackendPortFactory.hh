...
#ifndef OBJECTLOCATION_OPC_UA_BACKEND_PORTFACTORY_HH_
#define OBJECTLOCATION_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ObjectLocationOpcUaBackendPortFactory: public ObjectLocationPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ObjectLocationOpcUaBackendPortFactory();
	virtual ~ObjectLocationOpcUaBackendPortFactory();
...
#endif /* OBJECTLOCATION_SERONET_SDK_PORTFACTORY_HH_ */
