...
#ifndef OBJECTLOCATION_EXTENSION_HH_
#define OBJECTLOCATION_EXTENSION_HH_
...
public:
	ObjectLocationExtension(const std::string &name);
	virtual ~ObjectLocationExtension();
...
#endif /* OBJECTLOCATION_EXTENSION_HH_ */
