...
#ifndef OBJECTLOCATION_ACE_PORTFACTORY_HH_
#define OBJECTLOCATION_ACE_PORTFACTORY_HH_
...
class ObjectLocationAcePortFactory: public ObjectLocationPortFactoryInterface
{
private:
	ObjectLocationImpl *componentImpl;
public:
	ObjectLocationAcePortFactory();
	virtual ~ObjectLocationAcePortFactory();

	virtual void initialize(ObjectLocation *component, int argc, char* argv[]) override;
...
#endif /* OBJECTLOCATION_ACE_PORTFACTORY_HH_ */
