...
#ifndef FACEDETECTION_EXTENSION_HH_
#define FACEDETECTION_EXTENSION_HH_
...
public:
	FaceDetectionExtension(const std::string &name);
	virtual ~FaceDetectionExtension();
...
#endif /* FACEDETECTION_EXTENSION_HH_ */
