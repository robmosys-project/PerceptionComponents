...
static FaceDetectionAcePortFactory acePortFactory;

FaceDetectionAcePortFactory::FaceDetectionAcePortFactory()
{  
	componentImpl = 0;
	FaceDetection::instance()->addPortFactory("ACE_SmartSoft", this);
}

FaceDetectionAcePortFactory::~FaceDetectionAcePortFactory()
{  }

void FaceDetectionAcePortFactory::initialize(FaceDetection *component, int argc, char* argv[])
{
	if(component->connections.component.defaultScheduler != "DEFAULT") {
		...
		componentImpl = new FaceDetectionImpl(component->connections.component.name, argc, argv, sched_params);
	} else {
		// create new instance of the SmartSoft component
		componentImpl = new FaceDetectionImpl(component->connections.component.name, argc, argv);
	}
}

int FaceDetectionAcePortFactory::onStartup()
{
...
SmartACE::SmartComponent* FaceDetectionAcePortFactory::getComponentImpl()
{
	return componentImpl;
}

int FaceDetectionAcePortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
	componentImpl->stopComponentInfrastructure(timeoutTime);
	return 0;
}

void FaceDetectionAcePortFactory::destroy()
{
