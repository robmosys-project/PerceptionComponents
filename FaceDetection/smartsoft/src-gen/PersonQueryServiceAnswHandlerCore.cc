...
PersonQueryServiceAnswHandlerCore::PersonQueryServiceAnswHandlerCore(Smart::IQueryServerPattern<CommPerception::Empty, CommPerception::CommPersonDetection, SmartACE::QueryId>* server)
:	Smart::IQueryServerHandler<CommPerception::Empty, CommPerception::CommPersonDetection, SmartACE::QueryId>(server)
{
	
}

PersonQueryServiceAnswHandlerCore::~PersonQueryServiceAnswHandlerCore()
{
