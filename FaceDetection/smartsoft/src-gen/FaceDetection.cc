...
#include "FaceDetectionAcePortFactory.hh"


// initialize static singleton pointer to zero
FaceDetection* FaceDetection::_faceDetection = 0;

// constructor
FaceDetection::FaceDetection()
{
	std::cout << "constructor of FaceDetection\n";
	...
	connections.component.name = "FaceDetection";
	...
	// initialize members of FaceDetectionROSExtension
	
	// initialize members of PlainOpcUaFaceDetectionExtension
	
}

void FaceDetection::addPortFactory(const std::string &name, FaceDetectionPortFactoryInterface *portFactory)
{
	portFactoryRegistry[name] = portFactory;
}

void FaceDetection::addExtension(FaceDetectionExtension *extension)
{
	componentExtensionRegistry[extension->getName()] = extension;
}

SmartACE::SmartComponent* FaceDetection::getComponentImpl()
{
	return dynamic_cast<FaceDetectionAcePortFactory*>(portFactoryRegistry["ACE_SmartSoft"])->getComponentImpl();
}
 ...
 */
void FaceDetection::setStartupFinished() {
 ...
 */
void FaceDetection::startAllTasks() {
 ...
 */
void FaceDetection::startAllTimers() {
}
...
void FaceDetection::init(int argc, char *argv[])
{
	try {
		Smart::StatusCode status;
		...
		// initializations of FaceDetectionROSExtension
		
		// initializations of PlainOpcUaFaceDetectionExtension
		...
		FaceDetectionPortFactoryInterface *acePortFactory = portFactoryRegistry["ACE_SmartSoft"];
		if(acePortFactory == 0) {
		...
		SmartACE::SmartComponent *component = dynamic_cast<FaceDetectionAcePortFactory*>(acePortFactory)->getComponentImpl();
		
		std::cout << "ComponentDefinition FaceDetection is named " << connections.component.name << std::endl;
...
void FaceDetection::fini()
{
	...
	// destruction of FaceDetectionROSExtension
	
	// destruction of PlainOpcUaFaceDetectionExtension
	
}

void FaceDetection::loadParameter(int argc, char *argv[])
{
	/*
	...
	try
	{
		...
		} else if(parameter.searchFile("FaceDetection.ini", parameterfile)) {
			parameterFileFound = true;
			std::cout << "load FaceDetection.ini parameter file\n";
			parameter.addFile(parameterfile);
		} else {
			std::cout << "WARNING: FaceDetection.ini parameter file not found! (using default values or command line arguments)\n";
		}
		...
		// load parameters for FaceDetectionROSExtension
		
		// load parameters for PlainOpcUaFaceDetectionExtension
