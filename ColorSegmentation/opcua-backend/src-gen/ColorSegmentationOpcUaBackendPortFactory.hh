...
#ifndef COLORSEGMENTATION_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COLORSEGMENTATION_OPC_UA_BACKEND_PORTFACTORY_HH_

// include the main component-definition class
#include "ColorSegmentationPortFactoryInterface.hh"
...
class ColorSegmentationOpcUaBackendPortFactory: public ColorSegmentationPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ColorSegmentationOpcUaBackendPortFactory();
	virtual ~ColorSegmentationOpcUaBackendPortFactory();

	virtual void initialize(ColorSegmentation *component, int argc, char* argv[]) override;
...
#endif /* COLORSEGMENTATION_SERONET_SDK_PORTFACTORY_HH_ */
