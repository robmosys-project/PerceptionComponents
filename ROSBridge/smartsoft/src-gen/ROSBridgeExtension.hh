...
#ifndef ROSBRIDGE_EXTENSION_HH_
#define ROSBRIDGE_EXTENSION_HH_
...
public:
	ROSBridgeExtension(const std::string &name);
	virtual ~ROSBridgeExtension();
