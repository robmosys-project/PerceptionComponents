...
#ifndef COMPONENTFACERECOGNITION_EXTENSION_HH_
#define COMPONENTFACERECOGNITION_EXTENSION_HH_
...
public:
	ComponentFaceRecognitionExtension(const std::string &name);
	virtual ~ComponentFaceRecognitionExtension();
...
#endif /* COMPONENTFACERECOGNITION_EXTENSION_HH_ */
