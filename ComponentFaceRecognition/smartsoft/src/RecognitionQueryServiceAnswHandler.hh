...
protected:
public:
	RecognitionQueryServiceAnswHandler(IQueryServer *server);
	virtual ~RecognitionQueryServiceAnswHandler() = default;
	virtual void handleQuery(const QueryId &id, const DomainVision::CommVideoImage& request);
};
#endif
