...
#ifndef FACERECOGNITION_EXTENSION_HH_
#define FACERECOGNITION_EXTENSION_HH_
...
public:
	FaceRecognitionExtension(const std::string &name);
	virtual ~FaceRecognitionExtension();
...
#endif /* FACERECOGNITION_EXTENSION_HH_ */
